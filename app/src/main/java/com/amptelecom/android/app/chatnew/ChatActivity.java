...
import com.amptelecom.android.app.chat.DevicesFragment;
import com.amptelecom.android.app.chat.EphemeralFragment;
import com.amptelecom.android.app.chat.GroupInfoFragment;
import com.amptelecom.android.app.chat.ImdnFragment;
...
public class ChatActivity extends MainActivity {
    ...
    private void handleIntentExtras(Intent intent) {
        ...
        Fragment currentFragment = getFragmentManager().findFragmentById(R.id.fragmentContainer);
        if (currentFragment == null || !(currentFragment instanceof ChatHistoryFragment)) {
            showChatRooms();
        }
    ...
    //    public void showChatRoom(String chatid) {
    //        showChatRoomFinal(chatid);
    //    }
