...
import com.amptelecom.android.app.call.AndroidAudioManager;
import com.amptelecom.android.app.call.CallManager;
...
import com.amptelecom.android.app.utils.MediaScanner;
...
public class LinphoneManager implements SensorEventListener {
    ...
    private synchronized void configureCore() {
        ...
        String androidVersion = com.amptelecom.android.app.BuildConfig.VERSION_NAME;
